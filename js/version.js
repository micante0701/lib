export function getVersion() {
    return [
        ["V6.0.0", "2026/03/20", "NOTE", "原本以為至頂、至底功能有用，後來發現跳章節才是重點", "", ""],
        ["V6.0.0", "2026/03/20", "NEW", "新增背景播放佛號功能", "", ""],
        ["V6.0.0", "2026/03/20", "DELETE", "「↑」、「↓」至頂、至底功能刪除", "", ""],
        ["V6.0.0", "2026/03/20", "NEW", "「↑」、「↓」改跳躍章節的功能", "", ""],
        ["V6.0.0", "2026/03/20", "IMPROVE", "首頁版本編號預設字樣微調", "", ""],
        ["V6.0.0", "2026/03/20", "IMPROVE", "優化經文原文顯示方式(CSS)", "", ""],
        ["V6.0.0", "2026/03/20", "IMPROVE", "調整、優化網站布局(檔案路徑、命名規則、JS規劃等)", "", ""],
        ["V5.7.3", "2026/03/18", "NOTE", "原本打算解決離線瀏覽Bug，結果備份出問題，搞到崩潰，維修超久，進度一度變成負值", "", ""],
        ["V5.7.3", "2026/03/18", "DELETE", "V5.7.2 離線瀏覽功能加強(針對手機自動清除快取)", "", ""],
        ...
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "note", "剛做，也沒什麼想法，很多天都沒作為"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "歧路指歸(未完成)"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "佛說無量壽經"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "大乘無量壽經白話解"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "無量壽經甄解(一)(未完成)"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "佛說觀無量壽佛經"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "大乘起信論(未完成)"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "十二門論(未完成)"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "大寶積經(未完成)"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "佛說佛地經"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "佛地經論(一)(未完成)"],
        ["2025/10/23~2025/11/26：這期間沒特別紀錄", "", "EXPAND", "彌陀圓中鈔(未完成)"],
